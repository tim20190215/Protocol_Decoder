...
class Decoder(srd.Decoder):
    ...
    annotations = (
        ...
        ('207', 'miso-bits', 'MISO bits'),                          #2
        ('209', 'mosi-bits', 'MOSI bits'),                          #3
        ('1000', 'warnings', 'Human-readable warnings'),            #4

        ('6', 'miso-transfer', 'MISO transfer'),                    #5
        ('8', 'mosi-transfer', 'MOSI transfer'),                    #6

        ('308', 'reg-header-r', 'Register Header Read'),            #7
        ('310', 'reg-header-w', 'Register Header Write'),           #8
        ('301', 'locality1-reg-r', 'Locality 1 Register Read'),     #9
        ('302', 'locality1-reg-w', 'Locality 1 Register Write'),    #10
        ('301', 'locality2-reg-r', 'Locality 2 Register Read'),     #11
        ('302', 'locality2-reg-w', 'Locality 2 Register Write'),    #12
        ('301', 'locality3-reg-r', 'Locality 3 Register Read'),     #13
        ('302', 'locality3-reg-w', 'Locality 3 Register Write'),    #14
        ('301', 'locality4-reg-r', 'Locality 4 Register Read'),     #15
        ('302', 'locality4-reg-w', 'Locality 4 Register Write'),    #16

        ('301', 'reg-name', 'Register Name'),                       #17
        ('304', 'reg-sizeofxfer', 'Size of Transfer'),              #18
        ('305', 'reg-ack', 'Ack byte'),                             #19
        ('300', 'reg-nack', 'NAck byte'),                           #20
        ('309', 'reg-data-w', 'Reg Data Write'),                    #21
        ('307', 'reg-data-r', 'Reg Data Read'),                     #22

        ('402', 'state-1', 'State 1'),                              #23
        ('403', 'state-2', 'State 2'),                              #24
        ('400', 'state-3', 'State 3'),                              #25

        ('501', 'cmd-tag', 'Command Tag'),                          #26
        ('504', 'cmd-len', 'Command Length'),                       #27
        ('502', 'cmd-ord', 'Command Code'),                         #28
        ('509', 'cmd-data-w', 'Command Data Write'),                #29
        ('507', 'cmd-data-r', 'Command Data Read'),                 #30

        ('610', 'frame-reg-sizeofxfer-w', 'Frame Sizeof Xfer-w'),   #31
        ('608', 'frame-reg-sizeofxfer-r', 'Frame Sizeof Xfer-r'),   #32
        ('601', 'frame-reg-name', 'Frame Register Name'),           #33
        ('605', 'frame-reg-ack', 'Frame Ack byte'),                 #34
        ('600', 'frame-reg-nack', 'Frame NAck byte'),               #35
        ('609', 'frame-data-w', 'Frame Write'),                     #36
        ('607', 'frame-data-r', 'Frame Read'),                      #37

        ('701', 'frame-cmd-tag', 'Frame Command Tag'),              #38
        ('704', 'frame-cmd-len', 'Frame Command Length'),           #39
        ('702', 'frame-cmd-ord', 'Frame Command Code'),             #40
        ('709', 'frame-cmd-data-w', 'Frame Command Data Write'),    #41
        ('707', 'frame-cmd-data-r', 'Frame Command Data Read'),     #42

        ('802', 'frame-state-1', 'Frame state 1'),                  #43
        ('803', 'frame-state-2', 'Frame state 2'),                  #44
        ('800', 'frame-state-3', 'Frame state 3'),                  #45
        ('814', 'frame-state-4', 'Frame state 4'),                  #46
        ('815', 'frame-state-5', 'Frame state 5'),                  #47
        ('801', 'frame-state-6', 'Frame state 6'),                  #48

        ('0', 'cmd-err', 'Command Error'),                          #49
        ('0', 'state-err', 'State Error'),                          #50
        ('0', 'reg-err', 'Register Error'),                         #51
        ('0', 'frame-cmd-err', 'Frame Command Error'),              #52
        ('0', 'frame-state-err', 'Frame State Error'),              #53
        ('0', 'frame-reg-err', 'Frame Register Error'),             #54
    )
    annotation_rows = (
